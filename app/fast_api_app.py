...
app.title = "dipguard-os"
app.description = "API for interacting with the Agent dipguard-os"
...
@app.get("/scan")
def scan_portfolio_endpoint() -> list[dict]:
    """Scan portfolio for dip opportunities.

    Returns:
        List of portfolio scan results with scores and classifications.
    """
    from app.agent import scan_portfolio

    return scan_portfolio()
